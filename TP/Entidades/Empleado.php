...
class Empleado
{
    ...
    public static function CantidadOperacionesEmpleadosPorSector($sector)
    {
        try {
            ...
            $consulta = $objetoAccesoDato->RetornarConsulta("SELECT perfil as sector, e.id, e.nombre, e.operaciones as CantidadOperaciones FROM empleados e WHERE perfil = :sector");
